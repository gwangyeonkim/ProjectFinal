...
<body>
    ...
    <form action="./singUp.do" method="post" id="join_form">
<div class="container">
        ...
        <div class="form-group">
            ...
            <input type="text" placeholder="Enter name" id="name" name="memName" required>
            <span class="point checkNameComment">이름은 2자 이상 적어주세요.(한글만)</span>
            <input type="hidden" id="doubleCheckName"/>
        </div>
        <div class="form-group">
            <label for="password">Password</label>
            <input type="Password" placeholder="Enter password" id="memPw" name="memPw" required>
        </div>
        <div class="form-group">
            <label for="password">Validation Password</label>
            <input type="Password" placeholder="Enter password"  id="validPassword" required>
        ...
        <div class="form-group">
            ...
            <input type="button" id="checkEmailBtn" class="btn btn-info">인증번호 보내기<br/><br>
        ...
        <div class="form-group">
            ...
            <input type="button" id="checkHpBtn" class="btn btn-info">인증번호 보내기<br/>
